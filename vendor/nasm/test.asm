...
section .data
	_0x0068656c6c6f: db 'This is a test message and this is kinda long because I have to test if this works right...',10
	_0x0068656c6c4a: db 'Another message',10
...
_print:
	...
	int 	80h		; Call kernel and print the string
